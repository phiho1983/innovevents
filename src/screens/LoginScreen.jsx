...
export default function LoginScreen({navigation}){
  ...
  async function handleLogin(){
    ...
    }catch(e){ Alert.alert("Erreur","Identifiants invalides") }
  ...
  return(
    <View style={s.container}>
      ...
      <TextInput style={s.input} placeholder="Identifiant" value={username} onChangeText={setUsername} autoCapitalize="none"/>
