  ...
  if (invalidLink) {
    return (
      <>
        ...
        >
          <p>Ce lien d&apos;activation est incomplet ou invalide.</p>
          <p>
            Vérifiez que vous avez utilisé le lien complet reçu
            par e-mail.
          </p>
        </AuthStatus>
      </>
  ...
  return (
    <>
      ...
      <AuthForm
        ...
        subtitle={
          <>
            Votre compte Innov&apos;Events est prêt. Choisissez
        ...
        onSubmit={async (values) => {
          await activateAccount(uid, token, values.password);

          const authenticatedUser = await refreshMe();

          if (!authenticatedUser) {
            throw new Error(
              "Le compte a été activé, mais la connexion automatique "
              + "a échoué."
            );
          }
